...
{
    /// <summary>
    /// Script responsible of generating points on the road piece (start, end and left (in crossroads).
    /// Used in the random road generator
    /// </summary>
    ...
    public class RoadPoints : MonoBehaviour
    {
        ...
        [Tooltip("The type of road that the script is attached to.")] [SerializeField]
        private RoadType roadType;

        [Tooltip("Width of the road (or the road square area).")] [SerializeField]
        private int width = 8;

        [Tooltip("Length of the road (or the road square area).")] [SerializeField]
        private int length = 8;

        [Tooltip("How many curve points should be generated on the curve.")] [SerializeField]
        private int curvePoints = 20;

        [Tooltip("Offset used if the road is not a perfect rectangle.\n" +
                 "In our case is the offset created by the sticking out pieces on the sides.")]
        [SerializeField]
        private float specialOffset;
        ...
        public float RoadHeight => _roadHeight;
        ...
        private void GenerateCurve(ref List<Vector3> curves, int numberOfPoints, Vector3 startPoint,
            Vector3 helperPoint,
            Vector3 endPoint)
        {
        ...
        /// <param name="spawnOneCurve"> Check if it should spawn only one curve</param>
        /// <param name="spawnTwoCurves"> Check if it should spawn only one curve</param>
        ...
        /// <summary>
        /// Method used to calculate the bezier curve used to move the player smoothly on the path.
        /// Method generated with the help of Chat GPT.
        /// </summary>
